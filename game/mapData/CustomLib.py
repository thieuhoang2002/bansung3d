...
def createTree(x=0, z=0) -> Entity:
    return Entity(model='assets/models/tree/Tree.obj',
                  texture='assets/models/tree/tree2.jpeg',
...
def createHouse(x=0, z=0, corner=0) -> Entity:
    return Entity(
        model='assets/models/house/farmhouse.obj',
        position=(x, 1, z),
        texture='assets/models/house/Farmhouse Texture.jpg',
        scale=10,
        rotation_y=corner,
        collider='box',
    )
